...
SupportLevel = Literal["native", "limited", "unsupported", "external_required", "wsl_supported"]
...
FEATURE_MATRIX: Dict[str, FeatureDefinition] = {
    "wireless.monitor_mode": FeatureDefinition(
        ...
        wsl_notes="Requires USB Wi-Fi adapter with monitor mode support passed through to WSL via usbipd-win.",
    ...
    "wireless.packet_injection": FeatureDefinition(
        ...
        wsl_notes="Requires USB Wi-Fi adapter with injection support passed through to WSL via usbipd-win.",
    ...
    "wireless.wps_attack": FeatureDefinition(
        ...
        wsl_notes="Requires USB Wi-Fi adapter with monitor mode passed through to WSL via usbipd-win.",
    ...
    "wireless.aircrack": FeatureDefinition(
        ...
        wsl_notes="Fully supported in WSL without hardware requirements.",
    ...
    "wireless.hashcat": FeatureDefinition(
        ...
        wsl_notes="GPU support in WSL2 requires WSL-GPU drivers; CPU mode always works.",
    ...
    "discovery.nmap_full": FeatureDefinition(
        ...
        wsl_notes="Fully supported in WSL; requires admin privileges.",
